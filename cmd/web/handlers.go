...
func (app *application) CreateDogFormAbstractFactory(w http.ResponseWriter, r *http.Request) {
	var t toolbox.Tools
...
func (app *application) CreateCatFormAbstractFactory(w http.ResponseWriter, r *http.Request) {
	var t toolbox.Tools
...
func (app *application) CreateDogWithBuilder(w http.ResponseWriter, r *http.Request) {
	...
	p, err := pets.NewPetBuilder().
		...
		SetWeight(15).
		SetDescription("A mixed breed of unknown origin. Probably has some Gernam Shepherd heritage.").
